...
export const buildingsByRace: Record<Race, BuildingDefinition[]> = {
  human: [{ key: "main", name: "Königssitz", icon: "♜", gold: 0, wood: 0, seconds: 0, kind: "main" }, b("barracks", "Kaserne", "⚔", "barracks"), b("food", "Hof", "⌂", "food"), b("forge", "Königsschmiede", "⚒", "forge"), b("magic", "Arkaner Turm", "✦", "magic"), b("siege", "Werkhof", "⚙", "siege"), b("air", "Greifenwarte", "◆", "air"), b("defense", "Grenzbollwerk", "▣", "defense")],
  orc: [{ key: "main", name: "Kriegshalle", icon: "♜", gold: 0, wood: 0, seconds: 0, kind: "main" }, b("barracks", "Kampfgrube", "⚔", "barracks"), b("food", "Vorratshaus", "⌂", "food"), b("forge", "Eisenhütte", "⚒", "forge"), b("magic", "Schamanenzelt", "✦", "magic"), b("siege", "Belagerungswerk", "⚙", "siege"), b("air", "Wyvernhorst", "◆", "air"), b("defense", "Wachtotem", "▣", "defense")],
  undead: [{ key: "main", name: "Nekropole", icon: "♜", gold: 0, wood: 0, seconds: 0, kind: "main" }, b("barracks", "Knochengruft", "⚔", "barracks"), b("food", "Seelenbrunnen", "⌂", "food"), b("forge", "Knochenesse", "⚒", "forge"), b("magic", "Schattenzirkel", "✦", "magic"), b("siege", "Seuchenwerk", "⚙", "siege"), b("air", "Frosthorst", "◆", "air"), b("defense", "Geisterwall", "▣", "defense")],
  nightelf: [{ key: "main", name: "Weltenbaum", icon: "♜", gold: 0, wood: 0, seconds: 0, kind: "main" }, b("barracks", "Kriegerhain", "⚔", "barracks"), b("food", "Mondbrunnen", "⌂", "food"), b("forge", "Sternenschmiede", "⚒", "forge"), b("magic", "Ältestenhain", "✦", "magic"), b("siege", "Wurzelwerk", "⚙", "siege"), b("air", "Chimärennest", "◆", "air"), b("defense", "Wächterbaum", "▣", "defense")],
};
